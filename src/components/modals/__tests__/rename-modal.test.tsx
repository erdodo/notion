...
describe('RenameModal', () => {
  ...
  it('should render dialog when modal is open', () => {
    ...
    expect(screen.getByText('Enter a new name for this page.')).toBeInTheDocument()
  })
  ...
  it('should display initial title in input field', () => {
    ...
    const input = screen.getByDisplayValue('My Document') as HTMLInputElement
  ...
  it('should update input when initialTitle changes', () => {
    ...
    const updatedInput = screen.getByDisplayValue('Updated Title') as HTMLInputElement
  ...
  it('should prevent event propagation in dialog', async () => {
    ...
    // Click propagation should be stopped
