...
describe('Tabs', () => {
  ...
  it('should work as documentation tabs', async () => {
    ...
    expect(screen.getByText("import Package from 'package'")).toBeInTheDocument()
  })
  ...
  it('should handle long tab names', () => {
    render(
      <Tabs defaultValue="tab1">
        <TabsList>
          <TabsTrigger value="tab1">Very Long Tab Name That Might Wrap</TabsTrigger>
  ...
  it('should forward ref to tabs element', () => {
    ...
    render(
      <Tabs ref={el => (ref = el)} defaultValue="tab1">
        <TabsList>
          <TabsTrigger value="tab1">Tab 1</TabsTrigger>
        </TabsList>
        <TabsContent value="tab1">Content</TabsContent>
