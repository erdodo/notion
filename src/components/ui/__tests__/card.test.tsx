...
describe('Card Components', () => {
  ...
  describe('Card', () => {
    ...
    it('should forward ref', () => {
      let cardReference: HTMLDivElement | null = null;
      render(
        <Card
          ref={(element) => {
            cardReference = element;
          }}
        >
          Content
        </Card>
  ...
  describe('CardTitle', () => {
    ...
    it('should forward ref', () => {
      let titleReference: HTMLHeadingElement | null = null;
      render(
        <CardTitle
          ref={(element) => {
            titleReference = element;
          }}
        >
          Title
        </CardTitle>
  ...
  describe('CardDescription', () => {
    ...
    it('should forward ref', () => {
      let descReference: HTMLParagraphElement | null = null;
      render(
        <CardDescription
          ref={(element) => {
            descReference = element;
          }}
        >
          Description
        </CardDescription>
