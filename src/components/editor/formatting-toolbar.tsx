...
const BACKGROUND_COLORS = [
    ...
    { name: "Gray", value: "gray", lightColor: "rgb(241, 241, 239)", darkColor: "rgb(71, 76, 80)" },
    { name: "Brown", value: "brown", lightColor: "rgb(244, 238, 234)", darkColor: "rgb(67, 64, 64)" },
    { name: "Orange", value: "orange", lightColor: "rgb(251, 236, 221)", darkColor: "rgb(89, 74, 58)" },
    { name: "Yellow", value: "yellow", lightColor: "rgb(251, 243, 219)", darkColor: "rgb(89, 86, 59)" },
    { name: "Green", value: "green", lightColor: "rgb(237, 243, 236)", darkColor: "rgb(53, 76, 75)" },
    { name: "Blue", value: "blue", lightColor: "rgb(231, 243, 248)", darkColor: "rgb(45, 66, 86)" },
    { name: "Purple", value: "purple", lightColor: "rgb(244, 240, 247)", darkColor: "rgb(73, 47, 100)" },
    { name: "Pink", value: "pink", lightColor: "rgb(249, 238, 243)", darkColor: "rgb(83, 59, 76)" },
    { name: "Red", value: "red", lightColor: "rgb(253, 235, 236)", darkColor: "rgb(89, 65, 65)" },
]
...
export function FormattingToolbar({ editor }: FormattingToolbarProps) {
    ...
    const updatePosition = useCallback(() => {
        ...
        // Only show toolbar if there's selected text
    ...
    return (
        ...
        >
            ...
            <Popover>
                ...
                <PopoverContent className="w-64 p-2" align="start">
                    <div className="text-xs font-medium mb-2 text-muted-foreground">Highlight Color</div>
                    <div className="grid grid-cols-5 gap-1">
