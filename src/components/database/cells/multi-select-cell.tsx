import { MoreHorizontal, Trash, X, Plus } from 'lucide-react';
...
export function MultiSelectCell({
  ...
  const options: Option[] = (property?.options as unknown as Option[]) || [];
                  ...
                  >
                    <div className="flex items-center gap-2 flex-1 overflow-hidden">
                      ...
                      <Badge
                        ...
                        className={cn(
                          'truncate',
                          getOptionColors(option.color).bg,
                          getOptionColors(option.color).text
                        )}
                      >
                        {option.name}
                      </Badge>
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-5 w-5 opacity-0 group-hover:opacity-100 p-0"
                          onClick={(e) => {
                            e.stopPropagation();
                          }}
                        >
