...
export function ViewSettingsMenu({
  ...
  const activeGroupBy =
    currentViewType === 'board' ? boardGroupByProperty : groupByProperty;
  const setActiveGroupBy =
    currentViewType === 'board' ? setBoardGroupByProperty : setGroupByProperty;
