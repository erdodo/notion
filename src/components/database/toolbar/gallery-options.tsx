...
export function GalleryOptions({ database }: GalleryOptionsProps) {
    const {
        galleryCardSize, setGalleryCardSize,
        galleryFitImage, toggleGalleryFitImage,
        galleryColumns, setGalleryColumns
    } = useDatabase()
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="space-y-2 pt-2">
                            <div className="flex justify-between items-center">
                                ...
                                <select
                                    ...
                                    onChange={(e) => setGalleryCardSize(e.target.value)}
                                >
                        ...
                        <div className="space-y-3 pt-2 border-t mt-2">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-xs text-muted-foreground">{galleryColumns || 4}</span>
                            </div>
                            <input
                                type="range"
                                min="1"
