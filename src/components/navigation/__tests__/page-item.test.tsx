...
describe('PageItem', () => {
  ...
  it('should handle child page creation error', async () => {
    ...
    (pageActions.createPage as any).mockRejectedValue(
  ...
  it('should apply proper padding based on level', () => {
    const { container } = render(
      <PageItem page={mockPage} onRefresh={mockOnRefresh} level={2} />
    );
  ...
  it('should render nested children with correct level', async () => {
    ...
    render(
      <PageItem page={pageWithNestedChildren} onRefresh={mockOnRefresh} />
    );
  ...
  it('should truncate long page titles', () => {
    ...
    const { container } = render(
      <PageItem page={pageWithLongTitle} onRefresh={mockOnRefresh} />
    );
  ...
  it('should handle multiple children', async () => {
    ...
    render(
      <PageItem page={pageWithMultipleChildren} onRefresh={mockOnRefresh} />
    );
