...
export function ShareDialog({
  ...
  const copyLink = async () => {
    const link =
      guestLink || `${globalThis?.location?.origin}/documents/${pageId}`;
        ...
        <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Select
                        value={share.role}
                        onValueChange={(v) =>
                          updateShareRole(share.id, v as ShareRole)
                        }
                      >
          ...
          <div className="space-y-3 pt-4 border-t">
            ...
            <div className="flex gap-2">
              <Input
                value={
                  guestLink || (origin ? `${origin}/documents/${pageId}` : '')
                }
                readOnly
